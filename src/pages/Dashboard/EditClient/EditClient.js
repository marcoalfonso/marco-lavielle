                ...
                <fieldset>
                  ...
                  <Form.Item label="Photo URL" className="form-group">
                    {getFieldDecorator("photo", {
                      initialValue:
                        this.props.client && this.props.client.photo,
                    })(<Input className="form-control" />)}
                  </Form.Item>
                  <Form.Item label="Description" className="form-group">
                    {getFieldDecorator("description", {
                      initialValue:
                        this.props.client && this.props.client.description,
...
const WrappedEditClientForm = Form.create({ name: "edit_client_form" })(
  EditClient
);
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withRouter(WrappedEditClientForm));
